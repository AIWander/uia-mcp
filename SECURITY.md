...
If you discover a security vulnerability in uia-mcp, please report it privately
via GitHub's Private Vulnerability Reporting:

1. Go to https://github.com/AIWander/uia-mcp/security
...
uia-mcp is under active development. Only the latest release receives security
fixes. Older releases are not supported.

## Scope

In scope:
- The uia-mcp binary/library and any bundled assets
